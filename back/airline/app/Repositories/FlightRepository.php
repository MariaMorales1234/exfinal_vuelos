<?php
    ...
    use App\Controllers\FlightControllers;
    use Exception;
    ...
    class FlightRepository {
        ...
        public function __construct(){
            $this->controller = new FlightControllers();
        }
        ...
        public function search(Request $request, Response $response){
            try {
                ...
                $result = $this->controller->search($params);
                if ($result === null) {
                    $payload = json_encode([
                        'status' => 'success',
                        'message' => 'No se encontraron vuelos con esos criterios',
                        'data' => []
                    ], JSON_UNESCAPED_UNICODE);
                    $response->getBody()->write($payload);
                    return $response
